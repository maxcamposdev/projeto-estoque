// pages/Produtos.jsx — CRUD de produtos (sem i18n)
  ...
  return (
    <div className="produtos">
      <div className="produtos-header">
        <h1>Produtos</h1>
        <button className="btn-primary" onClick={handleNew}>＋ Cadastrar Produto</button>
      </div>
        ...
        <>
          ...
          {totalPaginas > 1 && (
            <div className="paginacao">
              ...
              <span className="page-info">Página {pagina} de {totalPaginas} ({produtos.length} produtos)</span>
              <button className="btn-page" disabled={pagina === totalPaginas} onClick={() => setPagina((p) => p + 1)}>Próxima »</button>
            </div>
          )}
        </>
      )}
